...
function EditTpu() {
    ...
    const { data, setData, post, reset, errors, processing } = useForm({
        ...
        id_gampong: tpu.id_gampong,
        nama_gampong: tpu.nama_gampong,
    ...
    // mounted
    React.useEffect(() => {
        getKecamatan(tpu.id_kabupaten!);
        getGampong(tpu.id_kecamatan!);

        setValueKabupaten(`${tpu.id_kabupaten}-${tpu.nama_kabupaten}`);
        setValueKecamatan(`${tpu.id_kecamatan}-${tpu.nama_kecamatan}`);
        setValueGampong(`${tpu.id_gampong}-${tpu.nama_gampong}`);
